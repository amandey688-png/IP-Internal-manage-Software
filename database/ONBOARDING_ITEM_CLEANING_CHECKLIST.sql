-- ============================================================================
-- Onboarding > Item Cleaning Checklist (per Payment Status, after Item Cleaning)
-- Run in Supabase SQL Editor after onboarding_item_cleaning exists.
-- 18 fields, each Done/Not Done. Editable 48h after first submit.
-- ============================================================================
...
COMMENT ON TABLE public.onboarding_item_cleaning_checklist IS 'Item Cleaning Checklist (18 fields, Done/Not Done) per Payment Status. Shown after Item Cleaning. Editable 48h after submit.';
