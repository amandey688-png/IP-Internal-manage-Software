...
-- Run in Supabase SQL Editor. Backend expects this table and column names.
-- =============================================================================
...
comment on table public.db_client_client_onb is 'DB Client – Client ONB master-style rows (FastAPI uses service role; RLS for direct client access if added later).';
