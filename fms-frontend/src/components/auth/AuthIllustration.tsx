...
const RegisterIllustration = () => (
  <svg viewBox="0 0 380 300" style={{ maxWidth: '100%', height: 'auto' }} fill="none">
    <circle cx="130" cy="150" r="95" stroke={lightBlue} strokeWidth="2" strokeDasharray="8 6" fill="none" opacity={0.5} />
    {/* Person - head, body, cap */}
    ...
    {/* Corner accents */}
    <rect x="25" y="25" width="55" height="55" rx="14" fill={`${lightBlue}18`} stroke={lightBlue} strokeWidth="1" opacity={0.7} />
